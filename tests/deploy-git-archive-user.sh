...
cp deploy/deploy.sh deploy/app.service.template deploy/bootstrap-host.sh deploy/sudoers.template deploy/web-update-trigger.sudoers.template "${WORKTREE_DIR}/deploy/"
...
(
  ...
  git add package.json package-lock.json .env.example deploy/deploy.sh deploy/app.service.template deploy/bootstrap-host.sh deploy/sudoers.template deploy/web-update-trigger.sudoers.template
...
chmod +x "${FAKEBIN_DIR}/runuser" "${FAKEBIN_DIR}/getent" "${FAKEBIN_DIR}/npm" "${FAKEBIN_DIR}/npx" "${FAKEBIN_DIR}/systemctl" "${FAKEBIN_DIR}/systemd-analyze"
