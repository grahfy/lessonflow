...
notify_updates() {
  ...
  # The notification script needs to know where the shared data is located
  # to read the deployment metadata generated by deploy.sh.
  if ! REPO_ROOT="${REPO_ROOT}" SHARED_DIR="${SHARED_DIR}" npx tsx scripts/notify-updates.ts; then
